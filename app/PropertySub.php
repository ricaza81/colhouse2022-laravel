       ...
       public function fecha_fin_inquilino($id)
{
   ...
   public function inquilinos()
     ...
     public function tenant()
      {
       //dd($this->hasOne('App\User', 'id', 'id_tenant'));
       return $this->hasOne('App\User', 'id', 'id_tenant');
       }

         public function tenant2()
      {
       //dd($this->belongsTo('App\User', 'id', 'id_tenant'));
       return $this->belongsTo('App\User', 'id', 'id_tenant');
      ...
      {
       $id_tenant= User::where('property_sub_id','=',$id)->get();
       dd($id_tenant);
       return($id_tenant);
       }
  ...
  public function inquilino_role()
    ...
    public function facturas()
     ...
     public function facturas_vencidas($id)
      ...
      public function seguros_unidad_informe(){
      
         return count($this->hasOne('App\PropertiesSeguros', 'id_property_sub', 'id')->where('estado',1));
      }
          ...
          public function canon_unidad($id)
{
      //$resul=DB::table('properties')->where('id','=',$id)->latest()->first();
        ...
        $canon= DB::table('properties_sub_canon')->where('id_property_sub','=',$id)->first();
