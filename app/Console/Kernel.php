...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        \App\Console\Commands\ProrrogaAdminRenovacionContratos::class,
        \App\Console\Commands\NotificacionCodeudoresInquilinoMora::class,
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        //         ->dailyAt('05:59');
        $schedule->command('email:prorrogarenovacioncontratos')
                 ->dailyAt('02:43');
        $schedule->command('email:recordatorioadmin')
                 ->dailyAt('06:36');
