    ...
    <thead>
        ...
        <?php
            ...
            <tr role="row" class="odd"  >
                ...
                <td align="center" style="width:20px;padding:20px 20px 20px 20px;border-bottom:1px solid #4CAF50;background-color: #fff;color:#4CAF50;"><a href="{{url('/admin/tenants/'.$factura->tenant->id)}}">{{ $factura->tenant->name or '' }}</a></td>
