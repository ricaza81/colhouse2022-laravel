...
<br>
<div class="label label-warning">Por favor informe a los siguientes inquilinos del cambio de canon de arrendamiento.</div>
<br>
<br>

<div align="center" style="background: #eee; color:#000;
    line-height:22px;
    padding: 20px 20px 20px 20px;border-radius: 8px 8px 8px 8px;width: 90%;margin: auto;"><h2>Inquilinos próximos para actualización de canones de arrendamiento: (Informe 1 mes antes para comunicar al inquilino)</h2></div>
    ...
    <thead>
        ...
        <?php
            ...
            @if ($usuario->fecha_inicio_contrato->diffInDays(now())>250)
            <tr role="row" class="odd"  >
                ...
                <td align="center" style="width:20px;padding:20px 20px 20px 20px;border-bottom:1px solid #4CAF50;background-color: #fff;color:#4CAF50;">{{$usuario->duracion_meses}}<br/>
                 ...
                 <td align="center" style="width:20px;padding:20px 20px 20px 20px;border-bottom:1px solid #4CAF50;background-color: #fff;color:#4CAF50;">
                   ...
                   <a href="{{url('/admin/properties_sub/'.$usuario->subproperty->id)}}">Actualizar canon de arrendamiento</a>
                 </td>
