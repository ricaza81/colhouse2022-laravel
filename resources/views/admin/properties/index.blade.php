    ...
    border-radius: 4px;background: #e36b6a;">Ver Parametros</a>
                     ...
                     <div class="widget w-birthday-alert" style="height: 102px;border-radius:10px;margin-top:-10px;color:#fff;border-top: 2px solid #fff;padding-top:0px;padding: 18px;background: #2c587b;">
                              ...
                              <div class="wethear-now inline-items" style="margin-top:-20px">
                                    ...
                                    <div class="max-min-temperature">
                                     ...
                                     <div class="max-min-temperature" style="float:right;">
                                             ...
                                             <a href="{{ route('admin.properties_propietarios.indextotalpropietarios') }}" class="btn btn-sm bg-blue" style="margin-top: 13px;float: right; border: 2px solid #fff;">Ver
                                             </a>
                      ...
                      <div class="widget w-birthday-alert" style="height: 105px;border-radius:10px;margin-top:-18px;color:#fff;border-top: 2px solid #fff;padding-top:0px;padding: 18px;background: #2c587b;">
                              <div class="wethear-now inline-items" style="margin-top:-20px">
                                    <div class="max-min-temperature" style="font-size:46px;padding-left:6px;padding-top:4px;">{{$propietarios->count()}}
                                    </div>
                                    <div class="max-min-temperature">
                                     ...
                                     <div class="max-min-temperature" style="float:right;">
                                             ...
                                             <a href="{{ route('admin.properties_propietarios.indextotal') }}" class="btn btn-sm bg-blue" style="margin-top: 13px;float: right; border: 2px solid #fff;" target="_blank">Ver
                                             </a>
                    ...
                    <div class="widget w-action" style="border-radius:10px;margin-top:-25px;color:#fff;padding-left: 45px;border-top: 2px solid #fff;padding-top:0px;background: #e36b6a;">
                        <div class="wethear-now inline-items" style="margin-top:0px">
                            <div class="temperature-sensor" style="font-size:30px;padding-top:5px;padding-top:30px;margin-left: -17px;font-weight: 600;margin-top: -48px;">

                                <!--TotalFacturado-->
                                <span style="line-height:0.8px;font-size:16px;float: left;font-weight:400;">Total facturado
                                </span>
                                ${{ number_format($usuarioadmin->valor_total_facturado_inmobiliaria($usuarioadmin->id)), 0, ',', '.' }}
                                <!--TotalFacturado-->

                                <!--TotalPagado-->
                                <span style="line-height:0.8px;font-size:12px;float: left;font-weight:600;padding-top:10px">Total pagos(arrendamiento)
                                </span>
                                ${{ number_format($usuarioadmin->valor_total_ingresos_inmobiliaria($usuarioadmin->id)), 0, ',', '.' }}
                                <!--TotalPagado-->

                                <!--TotalCartera-->
                                <span style="line-height:0.8px;font-size:16px;float: left;font-weight:600;padding-top:10px">Cartera total
                                </span>
                                ${{ number_format($usuarioadmin->valor_total_cartera($usuarioadmin->id)), 0, ',', '.' }}
                                <!--{{ number_format($usuarioadmin->valor_total_facturado_inmobiliaria($usuarioadmin->id) - $usuarioadmin->valor_total_ingresos_inmobiliaria($usuarioadmin->id)), 0, ',', '.' }}-->
                                <!--TotalCartera-->
                   ...
                   <div class="widget w-action" style="border-radius:10px;margin-top:0px;color:#fff;padding-left:25px;border-top: 2px solid #fff;padding-top:0px;background:#41a542;height:200px;">
                              <div class="wethear-now inline-items" style="margin-top:10px">
                                  <div class="max-min-temperature">
                                         <span style="line-height:18px;font-size:14px;float: left;font-weight:600;padding-top:20px;">Ingresos por administración Total ColHouse
                                </span>
                                <span style="font-size:36px;font-weight:600;">${{ number_format($usuarioadmin->valor_total_comision_ingresos($usuarioadmin->id)), 0, ',', '.' }}
                                </span>
                                    <span class="skills-item-meter-active skills-animate" style="width:80%; opacity:1;background:linear-gradient(to right,#ff9432,#79a42e);height:8px;border:1px solid #fff;padding-top:12px;margin-top:12px"></span>
                                        <h5 >100%
                                        </h5>
                            
                            
                                   
                                             <a href="{{ route('admin.tenants.informe_inmobiliaria') }}" class="btn btn-block bg-blue"  target="_blank" style="color:#fff">Ver Informe
                                             </a>
                ...
                <div class="friend-item">
                    <div class="friend-header-thumb">
                        <a href="{{ asset(env('UPLOAD_PATH').'/' . $property->photo) }}" target="_self">
                           ...
                           @if ($property->inquilinos()->count() / $property->unidades()->count()  > 0.9)
                            <div class="control-block-button post-control-button"  style="float:left;z-index:70">
                            ...
                            @else
                             <div class="control-block-button post-control-button"  style="float:left;z-index:70;background:#000;">
                                <a href="{{route('admin.properties_sub.unidades_consulta',[$property->id])}}" class="btn btn-control featured-post" style="width:93px;padding-top:7px;background:#41a541;margin-top: -91px;border-radius:4px;padding-right: 15px;padding-left: 8px; border:2px solid #fff;height:46px;background:#000;" data-toggle="tooltip" title="Nivel de ocupación: {{number_format($property->inquilinos()->count()/$property->unidades()->count()*100)}}%">
                                    <div class="title">
                                        <h5 style="text-align:left;">Parcial:
                                        <br/>
                                         <div class="skills-item-meter responsive" style="padding-top:10px;padding-right:23px;">
                                              <span class="skills-item-meter-active skills-animate" style="width:38px; opacity:1;background:linear-gradient(to right,#ff9432,#79a42e);height:8px;border:1px solid #fff"></span>
                                        <h5 class="skills-item-meter-active skills-animate" style="opacity:1;">{{number_format($property->inquilinos()->count()/$property->unidades()->count()*100)}}%
                                ...
                                <div class="swiper-slide">
                                    <div class="friend-count" data-swiper-parallax="-500">
                                      ...
                                      @if($property->propietarios() >= 1) 
                                        ...
                                        data-toggle="tooltip" style="padding:15px" title="Propietario: {{$property->propietarios2($property->id)->nombre}}">
                                            <div class="items-round-little bg-blue" style="text-align:center;">{{ $property->propietarios()}}
                                            </div>
                                            <div class="title" style="text-align:center;">#Propietarios</div>
                                        </a>
