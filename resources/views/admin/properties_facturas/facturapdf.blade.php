...
<div class="row">
    ...
    <div class="col-md-4" style="float:left">      
          <h5 style="line-height:12px;">Información de la propiedad
               <h6>{{$factura->property_sub->nombre}},<br/>{{$factura->property->address}}
                        </h6>
                ...
                <table style="margin-left:210px;margin-top:-10px">
                  ...
                  <table style="margin-left:210px;margin-top:-25px">
                    <thead>
                            ...
                            <th width="240px" style="text-align:justify;margin-left:300px;padding-right:10px;padding-top:30px;">
                                 <h6 style="padding-top:16px;margin-bottom:-18px;text-align:justify;padding-right:20px;letter-spacing:0px;">Fecha Límite para evitar renovación automática de contrato para Vivienda urbana:
                           </h6>
                             @if ($factura->tenant->fecha_fin_contrato != NULL || $factura->tenant->prroroga_contrato($tenant->id) != NULL)
                                @if ($fecha_limite_renovacion < now()->toDateTimeString('Y-m-d'))
                                   <h6 style="text-align:justify;background:#f7d7da;padding:10px;border-radius:4px;border:2px solid #d75448">{{date('d/F/Y',strtotime($fecha_limite_renovacion))}}
                                   </h6>
                                @else
                                    <h6 style="text-align:justify;background:#d4edda;padding:10px;border-radius:4px;border:2px solid #5d9a5f">{{date('d/F/Y',strtotime($fecha_limite_renovacion))}}
                                    </h6>
                                @endif
                               @else
                            ...
                            <th width="240px" style="text-align:justify;margin-left:-10px;padding-top:52px">
                                
                    <h6 style="text-align:justify;;border:1px solid #000;border-radius:4px;padding:11px">Info: Sin embargo si su contrato
