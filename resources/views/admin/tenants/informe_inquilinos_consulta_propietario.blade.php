...
@section('content')
    ...
    <h3 class="page-title" style="padding:20px">Informe Consolidado Propietario: <b style="font-weight: 800">{{$propietario->nombre}}</b></h3>
    </div>
    @can('property_create')
    <p>
    ...
    <div class="panel panel-default">
        ...
        <div class="col-md-10">
           ...
           <div class="col-md-3 form-group">
                      ...
                      {!! Form::open(['method' => 'POST', 'route' => ['admin.tenants.informe_inquilinos_consulta_propietario_fechas']]) !!}
                   
                
                     <input type="hidden" name="id_propietario" value="<?=$id_propietario;?>" id="id_propietario">
                     <input type="text" name="cc_propietario" value="<?=$cc_propietario;?>" id="cc_propietario">
    ...
    <div class="row">
     ...
     @if ($fecha_inicio_informe != NULL)
                  ...
                  {!! Form::open(['method' => 'POST', 'route' => ['admin.tenants.imprimir_informe_propietario']
                  ]) !!}
         ...
         @if ($fecha_inicio_informe != NULL)
                  ...
                  {!! Form::open(['method' => 'POST', 'route' => ['admin.tenants.enviar_informe_propietario']
                  ]) !!}
