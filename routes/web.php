...
Route::group(['middleware' => ['auth', 'check_invitation'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::get('properties_propietarios.indextotalpropietarios', ['uses' => 'Admin\PropertiesPropietariosController@indextotalpropietarios', 'as' => 'properties_propietarios.indextotalpropietarios']);
...
//<------->
    ...
    /*---Imprimir informe propietario--*/
    Route::post('tenants.informe_inquilinos_consulta_fechas', ['uses' => 'Admin\TenantsController@informe_inquilinos_consulta_fechas', 'as' => 'tenants.informe_inquilinos_consulta_fechas']);
    Route::post('tenants.imprimir_informe_propietario', ['uses' => 'Admin\TenantsController@imprimir_informe_propietario', 'as' => 'tenants.imprimir_informe_propietario']);
    Route::get('tenants.imprimir_informe_propietario', ['uses' => 'Admin\TenantsController@imprimir_informe_propietario', 'as' => 'tenants.imprimir_informe_propietario']);
    /*---Imprimir informe propietario--*/

    Route::get('tenants.enviar_informe', ['uses' => 'Admin\TenantsController@enviar_informe', 'as' => 'tenants.enviar_informe']);
    Route::get('tenants.enviar_informe_propietario', ['uses' => 'Admin\TenantsController@enviar_informe_propietario', 'as' => 'tenants.enviar_informe_propietario']);
    //---InformePorPropiedad--//

    //---InformePorPropietario--//
    Route::get('tenants.informe_inquilinos_consulta_propietario/{id}', ['uses' => 'Admin\TenantsController@informe_inquilinos_consulta_propietario', 'as' => 'tenants.informe_inquilinos_consulta_propietario']);
    Route::post('tenants.informe_inquilinos_consulta_propietario/{id}', ['uses' => 'Admin\TenantsController@informe_inquilinos_consulta_propietario', 'as' => 'tenants.informe_inquilinos_consulta_propietario']);
    Route::post('tenants.informe_inquilinos_consulta_propietario_fechas', ['uses' => 'Admin\TenantsController@informe_inquilinos_consulta_propietario_fechas', 'as' => 'tenants.informe_inquilinos_consulta_propietario_fechas']);
    Route::get('tenants.imprimir_informe_propietario', ['uses' => 'Admin\TenantsController@imprimir_informe_propietario', 'as' => 'tenants.imprimir_informe']);
    Route::get('tenants.enviar_informe', ['uses' => 'Admin\TenantsController@enviar_informe', 'as' => 'tenants.enviar_informe']);
    //---InformePorPropietario--//


//<!--Informe inmobiliaria-->
     Route::get('tenants.informe_inmobiliaria', ['uses' => 'Admin\TenantsController@informe_inmobiliaria', 'as' => 'tenants.informe_inmobiliaria']);
    Route::post('tenants.informe_inmobiliaria_consulta_fechas', ['uses' => 'Admin\TenantsController@informe_inmobiliaria_consulta_fechas', 'as' => 'tenants.informe_inmobiliaria_consulta_fechas']);
//<!--Informe inmobiliaria-->
...
//<!--renovacion_contratos-->
    ...
    Route::post('tenants.enviar_informe', ['uses' => 'Admin\TenantsController@enviar_informe', 'as' => 'tenants.enviar_informe']);
        ...
        Route::post('tenants.enviar_informe_propietario', ['uses' => 'Admin\TenantsController@enviar_informe_propietario', 'as' => 'tenants.enviar_informe_propietario']);
